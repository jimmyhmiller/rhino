...
@Disabled(
        "Multiple cases fail because rebase V2 emits finer-grained line numbers than V1 (e.g."
                + " object-literal value lines, multi-line call arg lines). Integrate filtered these"
                + " via CompilerEnvirons.getSourceMapper, which doesn't exist upstream — re-enable"
                + " once V2 line emission is aligned with V1 or an upstream source-mapper exists.")
